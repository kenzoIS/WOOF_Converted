...
const salesVelocity = Array.from({ length: 14 }, (_, i) => ({
  day: `Day ${i + 1}`,
  physical: Math.random() * 15000 + 5000,
  online: Math.random() * 12000 + 4000,
}));
      ...
      <div className="bg-white border border-[#FFD9EC] rounded-2xl md:rounded-3xl p-4 md:p-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-3 bg-[#FFF2FA] border border-[#FFD9EC] rounded-lg md:rounded-xl px-3 md:px-4 py-2 md:py-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-xs text-[#223047] opacity-60 truncate">Retail Revenue</div>
              <div className="text-base md:text-xl font-bold text-[#223047]">₱9,180</div>
          ...
          <div className="flex items-center gap-2 md:gap-3 bg-[#FFF2FA] border border-[#FFD9EC] rounded-lg md:rounded-xl px-3 md:px-4 py-2 md:py-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-base md:text-xl font-bold text-[#223047]">248</div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 md:gap-6">
        ...
        <div className="lg:col-span-2 space-y-4 md:space-y-6">
          <div className="bg-white border border-[#FFD9EC] rounded-2xl md:rounded-3xl p-4 md:p-6 space-y-3 md:space-y-4">
            <div>
              <h3 className="text-base md:text-lg font-bold text-[#223047]">Sales Velocity Trend</h3>
              <p className="text-xs text-[#223047] opacity-60 mt-1">Last 14 days</p>
            </div>
            ...
            <div className="flex justify-center gap-4 md:gap-6 pt-2">
              ...
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-[#5CE1E6] rounded-full" />
                <span className="text-xs">Online Channels</span>
              </div>
            </div>
          </div>
