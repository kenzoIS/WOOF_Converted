...
const bookingForecastData = Array.from({ length: 30 }, (_, i) => ({
  day: `Day ${i + 1}`,
  actual: i < 20 ? 15 + Math.random() * 8 + i * 0.3 : null,
  forecast: i >= 15 ? 16 + Math.random() * 7 + i * 0.35 : null,
  confidenceLow: i >= 15 ? 12 + Math.random() * 5 + i * 0.25 : null,
  confidenceHigh: i >= 15 ? 20 + Math.random() * 9 + i * 0.4 : null,
}));
...
export function Services() {
  ...
  return (
    <div className="space-y-6 md:space-y-8 lg:space-y-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-3 bg-[#FFF2FA] border border-[#FFD9EC] rounded-lg md:rounded-xl px-3 md:px-4 py-2 md:py-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-xs text-[#223047] opacity-60 truncate">Services Revenue Today</div>
              <div className="text-base md:text-xl font-bold text-[#223047]">₱14,230</div>
          ...
          <div className="flex items-center gap-2 md:gap-3 bg-[#FFF2FA] border border-[#FFD9EC] rounded-lg md:rounded-xl px-3 md:px-4 py-2 md:py-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-base md:text-xl font-bold text-[#223047]">55</div>
            </div>
          </div>
      ...
      {/* BOOKING DEMAND FORECAST - Best Model Only */}
      <div className="bg-white border border-[#FFD9EC] rounded-2xl md:rounded-3xl p-4 md:p-6 lg:p-8 space-y-4 md:space-y-6">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 md:gap-4">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs md:text-sm text-[#223047] opacity-60 mt-1" style={{ lineHeight: "1.6" }}>
              AI-selected best model: <span className="font-semibold text-[#3AE4FA]">SARIMA</span> (MASE: 0.72, Accuracy: 89%)
            </p>
          </div>
        ...
        <ResponsiveContainer width="100%" height={300} className="md:!h-[400px]">
          <AreaChart data={bookingForecastData}>
            <defs>
              <linearGradient key="confidenceBandServices-gradient" id="confidenceBandServices" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#3AE4FA" stopOpacity={0.3} />
            ...
            />
            <Area
              key="area-confidence-high"
              type="monotone"
              dataKey="confidenceHigh"
              stroke="none"
              fill="url(#confidenceBandServices)"
              animationDuration={800}
            />
            <Area
              key="area-confidence-low"
              type="monotone"
          ...
          <div className="bg-[#FFF7FB] border border-[#FFD9EC] rounded-xl md:rounded-2xl p-4 md:p-6 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <div>
                ...
                <div className="text-xl md:text-2xl font-bold text-[#3AE4FA]">0.72</div>
              ...
              <div>
                ...
                <div className="text-xl md:text-2xl font-bold text-[#223047]">2.14</div>
              </div>
              <div>
                <div className="text-xs text-[#223047] opacity-60 mb-1">MAPE</div>
                <div className="text-xl md:text-2xl font-bold text-[#223047]">6.8%</div>
              </div>
              <div>
                <div className="text-xs text-[#223047] opacity-60 mb-1">R²</div>
                <div className="text-xl md:text-2xl font-bold text-[#223047]">0.89</div>
              </div>
            </div>
          </div>
